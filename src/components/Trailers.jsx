...
import { ChevronRight,ChevronLeft, Clapperboard, Heading3Icon, Play, Clock, Calendar} from 'lucide-react';
...
useEffect(() => {
  ...
  // this function helps to show the selected video trailer
            ...
            <div className={trailersStyles.layout}>
                <div className= {trailersStyles.leftSide}>
                    <div className = {trailersStyles.leftCard}>
                        ...
                        <Clapperboard className = {trailersStyles.titleIcon}/> Latest Trailers
                        </h2>
                  ...
                  >
                    ...
                    <div className= {trailersStyles.trendingSection} >
                        ...
                        {trailersData.slice(0, 3).map((trailer) => (
                            <div onClick={ () => selectTrailer(trailer)} role="button" tabIndex={0} onKeyDown={(e) => {
                                if(e.key === "Enter" || e.key === " ") selectTrailer(trailer);}}
                ...
                <div className= {trailersStyles.rightSide}>
                    ...
                    <div className = {trailersStyles.closeButton}>
                        <button title = "close" onClick={() => setIsPlaying(false)} className= {trailersStyles.closeButtonInner}>
                            ...
                            >
                            <img src= {featuredTrailer} 
                            alt= {featuredTrailer.title }className= {trailersStyles.thumbnailImage} loading = "eager"/>
                        ...
                        <div className= {trailersStyles.trailerInfo}>
                            <div className={trailersStyles.trailerInfoHeader}>
                            ...
                            <div className={trailersStyles.trailerMeta}>
                                ...
                                <span clasName = {trailersStyles.metaItem}>
                            ...
                            <div className= {trailersStyles.genreContainer}>
                                {featuredTrailer.genre.split(",").map((g, index) => (
                                    <span key={index} className={trailersStyles.genreTag}>{g.trim()}</span>
                                ))}
                            </div>
